...
const AddSubInternal = async (Internal) => {
...
// const getSubInternal = async (Internal) => {
...
// const getSubInternalAll = async (Internal) => {
//     // get all internal
...
// const removeSubInternal = async (Internal) => {
//     const { id } = Internal;
//     // delete internal
...
// const modifySubInternal = async (Internal) => {
