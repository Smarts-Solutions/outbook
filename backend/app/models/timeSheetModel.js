...
//       (timesheet.monday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) OR
//       (timesheet.tuesday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) OR
//       (timesheet.wednesday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) OR
//       (timesheet.thursday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) OR
//       (timesheet.friday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) OR
//       (timesheet.saturday_date BETWEEN CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY AND CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY)
//     ORDER BY
//       timesheet.id ASC;
//   `;
...
const { staff_id } = Timesheet; // weekOffset ko Timesheet se lena hai
let weekOffset = 1
// Calculate start and end dates based on weekOffset
const currentDate = new Date();
const currentWeekday = currentDate.getUTCDay(); // Sunday is 0, Monday is 1, ... Saturday is 6
const startOfWeek = new Date(currentDate);
startOfWeek.setUTCDate(currentDate.getUTCDate() - currentWeekday + (weekOffset * 7)); // Start of week
const endOfWeek = new Date(startOfWeek);
endOfWeek.setUTCDate(startOfWeek.getUTCDate() + 6); // End of week
