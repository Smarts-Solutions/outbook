                  ...
                  <>
                    <div className={`col-lg-${title === "update_theme" ? 12 : field.col_size}`}>
                      <div className="row mb-3">
                        ...
                        <div className={`z-2 col-lg-${title === "addgroup" ? 12 : 12}`}>
                          <Select
                            id={field.name}
                            name={field.name}
                            ...
                            styles={{
                              control: (provided, state) => ({
                                ...provided,
                                backgroundColor: field.disable ? "#eeeeee" : "white",
                                borderColor: formik.touched[field.name] && formik.errors[field.name] ? "red" : provided.borderColor,
                              }),
                            }}
