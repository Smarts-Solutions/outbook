...
const TaskTimesheet = () => {
  return (
    ...
    <div className='row'>
        ...
        <div>
            <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-info text-white float-end ms-2"> <i class="fa fa-plus pe-1"></i>  Job Timesheet</button>
            <button type="button" class="btn btn-info text-white float-end ">  
             <i class="fa-regular fa-plus pe-1"></i> Add</button>
             </div>    
