...
const CreateJob = () => {
    ...
    const req = {
      ...
      customer_id:
        location.state.goto == "Customer"
          ? location.state.details.id
          : location.state.details.customer_id.id,
  ...
  useEffect(() => {
    setBudgetedHours({
      hours:
        ...
        getJobDetails.data.budgeted_hours.split(":")[0],
      minutes:
        getJobDetails.loading &&
        getJobDetails.data.budgeted_hours.split(":")[1],
    });
    setReviewTime({
      hours:
        getJobDetails.loading && getJobDetails.data.review_time.split(":")[0],
      minutes:
        getJobDetails.loading && getJobDetails.data.review_time.split(":")[1],
    });
    setFeedbackIncorporationTime({
      hours:
        getJobDetails.loading &&
        getJobDetails.data.feedback_incorporation_time.split(":")[0],
      minutes:
        getJobDetails.loading &&
        getJobDetails.data.feedback_incorporation_time.split(":")[1],
    });
    setPreparationTimne({
      hours:
        getJobDetails.loading &&
        getJobDetails.data.total_preparation_time.split(":")[0],
      minutes:
        getJobDetails.loading &&
        getJobDetails.data.total_preparation_time.split(":")[1],
    });
    ...
    setJobData((prevState) => ({
      ...
      AccountManager:
        getJobDetails.loading &&
        getJobDetails.data.account_manager_officer_first_name +
          " " +
          getJobDetails.loading &&
        getJobDetails.data.account_manager_officer_last_name,
      Customer:
        getJobDetails.loading && getJobDetails.data.customer_trading_name,
      Client:
        location.state.goto == "Customer"
          ? getJobDetails.loading && getJobDetails.data.client_id
          : getJobDetails.loading && getJobDetails.data.client_trading_name,
      ClientJobCode:
        getJobDetails.loading && getJobDetails.data.client_job_code,
      CustomerAccountManager:
        getJobDetails.loading && getJobDetails.data.account_manager_officer_id,
      ...
      AllocatedOn:
        getJobDetails.loading && getJobDetails.data.allocated_on.split("T"),
      DateReceivedOn:
        getJobDetails.loading && getJobDetails.data.date_received_on.split("T"),
      YearEnd: getJobDetails.loading && getJobDetails.data.year_end,
      EngagementModel:
        getJobDetails.loading && getJobDetails.data.engagement_model,
      ExpectedDeliveryDate:
        getJobDetails.loading &&
        getJobDetails.data.expected_delivery_date.split("T"),
      DueOn: getJobDetails.loading && getJobDetails.data.due_on.split("T"),
      SubmissionDeadline:
        getJobDetails.loading &&
        getJobDetails.data.submission_deadline.split("T"),
      CustomerDeadlineDate:
        getJobDetails.loading &&
        getJobDetails.data.customer_deadline_date.split("T"),
      SLADeadlineDate:
        getJobDetails.loading &&
        getJobDetails.data.sla_deadline_date.split("T"),
      InternalDeadlineDate:
        getJobDetails.loading &&
        getJobDetails.data.internal_deadline_date.split("T"),
      FilingWithCompaniesHouseRequired:
        getJobDetails.loading && getJobDetails.data.filing_Companies_required,
      CompaniesHouseFilingDate:
        getJobDetails.loading &&
        getJobDetails.data.filing_Companies_date.split("T"),
      FilingWithHMRCRequired:
        getJobDetails.loading && getJobDetails.data.filing_hmrc_required,
      HMRCFilingDate:
        getJobDetails.loading && getJobDetails.data.filing_hmrc_date.split("T"),
      OpeningBalanceAdjustmentRequired:
        getJobDetails.loading && getJobDetails.data.opening_balance_required,
      OpeningBalanceAdjustmentDate:
        getJobDetails.loading &&
        getJobDetails.data.opening_balance_date.split("T"),
      NumberOfTransactions:
        getJobDetails.loading && getJobDetails.data.number_of_transaction,
      NumberOfTrialBalanceItems:
        getJobDetails.loading && getJobDetails.data.number_of_balance_items,
      Turnover: getJobDetails.loading && getJobDetails.data.turnover,
      NoOfEmployees:
        getJobDetails.loading && getJobDetails.data.number_of_employees,
      VATReconciliation:
        getJobDetails.loading && getJobDetails.data.vat_reconciliation,
      Bookkeeping: getJobDetails.loading && getJobDetails.data.bookkeeping,
      ProcessingType:
        getJobDetails.loading && getJobDetails.data.processing_type,
  ...
  const fieldErrors = {
    ...
    NumberOfTransactions:
      "Please Enter Number Of Transactions less than 1000000",
    NumberOfTrialBalanceItems:
  ...
  const handleSubmit = async () => {
    const req = {
      ...
      total_preparation_time:
        PreparationTimne.hours + ":" + PreparationTimne.minutes,
  ...
  const handleClose = () => {
    location.state.goto == "Customer"
      ? navigate("/admin/Clientlist", { state: location.state.details })
                ...
                <div>
                  <div className="tab-content">
                                    ...
                                    <div style={{ marginTop: 15 }}>
                                      <div className="row">
                                        <div className="col-lg-4">
                                          ...
                                          <select
                                            className="invoiced_dropdown form-select mb-3"
                                            name="Invoiced"
                                            onChange={HandleChange}
                    ...
                    {jobModalStatus && (
                      <Modal
                        show={jobModalStatus}
                        onHide={(e) => jobModalSetStatus(false)}
                        centered
                        size="lg"
                      >
                    ...
                    {showAddJobModal && (
                      <Modal
                        ...
                        onHide={(e) => setShowAddJobModal(false)}
                        centered
                        size="sm"
                      >
                        <Modal.Header closeButton>
                        ...
                        <Modal.Footer>
                          <Button
                            variant="secondary"
                            onClick={(e) => setShowAddJobModal(false)}
                          >
                            Close
                          </Button>
                          <Button
