    ...
    useEffect(() => {
        ...
        if (Object.keys(getJobDetails.data).length > 0) {
            ...
            setJobData(prevState => ({
                ...
                AllocatedOn: getJobDetails.data && getJobDetails.data.allocated_on,
                DateReceivedOn: getJobDetails.data && getJobDetails.data.date_received_on,
                ...
                ExpectedDeliveryDate: getJobDetails.data && getJobDetails.data.expected_delivery_date && getJobDetails.data.expected_delivery_date,
                DueOn: getJobDetails.data && getJobDetails.data.due_on && getJobDetails.data.due_on,
                SubmissionDeadline: getJobDetails.data && getJobDetails.data.submission_deadline && getJobDetails.data.submission_deadline,
                CustomerDeadlineDate: getJobDetails.data && getJobDetails.data.customer_deadline_date && getJobDetails.data.customer_deadline_date,
                SLADeadlineDate: getJobDetails.data && getJobDetails.data.sla_deadline_date && getJobDetails.data.sla_deadline_date,
                InternalDeadlineDate: getJobDetails.data && getJobDetails.data.internal_deadline_date && getJobDetails.data.internal_deadline_date,
                FilingWithCompaniesHouseRequired: getJobDetails.data && getJobDetails.data.filing_Companies_required,
                CompaniesHouseFilingDate: getJobDetails.data && getJobDetails.data.filing_Companies_date && getJobDetails.data.filing_Companies_date,
                FilingWithHMRCRequired: getJobDetails.data && getJobDetails.data.filing_hmrc_required,
                HMRCFilingDate: getJobDetails.data && getJobDetails.data.filing_hmrc_date && getJobDetails.data.filing_hmrc_date,
                OpeningBalanceAdjustmentRequired: getJobDetails.data && getJobDetails.data.opening_balance_required,
                OpeningBalanceAdjustmentDate: getJobDetails.data && getJobDetails.data.opening_balance_date && getJobDetails.data.opening_balance_date,
