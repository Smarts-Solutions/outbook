                ...
                const error = {
                    ...
                    alternate_email:
                        contact.alternate_email === ""
                            ? "Alternate Email Id is required"
    ...
    const validate2 = () => {
        ...
        for (const key in getCompanyDetails) {
            if (!getCompanyDetails[key]) {
                ...
                else if (key == "ClientIndustry")
                    newErrors[key] = "Please Enter Client Industry";
                else if (key == "TradingName")
                    newErrors[key] = "Please Enter Trading Name";
                else if (key == "TradingAddress")
                    newErrors[key] = "Please Enter Trading Address";
        ...
        for (const key in getPartnershipDetails) {
            if (!getPartnershipDetails[key]) {
                ...
                if (key === "ClientIndustry")
                    ...
                    newErrors[key] = "Please Enter VAT Number";
                else if (key === "Website") newErrors[key] = "Please Enter Website";
            }
        }
    ...
    const validateField1 = (index, field, value) => {
        ...
        switch (field) {
            ...
            case "alternate_phone":
                newErrors[index].alternate_phone = value
                    ? ""
                    : "Alternate Phone Number is required";
                break;
            default:
                                                                            ...
                                                                            <div className="col-lg-4">
                                                                                <div className="mb-3">
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        name="last_name"
                                                                                        value={
                                                                                            getSoleTraderDetails.last_name
                                                                                        }
                                                                                        onChange={(e) => handleChange1(e)}
                                                                                    />
                                                                                    {errors1["last_name"] && (
                                                                            ...
                                                                            <div className="card-body">
                                                                                <div className="row">
                                                                                    ...
                                                                                    <div className="col-lg-12 px-3">
                                                                                        <button
                                                                                            className="btn btn-info text-white blue-btn float-end"
