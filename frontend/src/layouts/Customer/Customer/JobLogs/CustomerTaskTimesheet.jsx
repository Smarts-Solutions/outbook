...
const CustomerTaskTimesheet = ({ job_id, getAccessDataJob, goto }) => {
  ...
  const handleExport = async () => {
    ...
    const response = await dispatch(CustomerTaskTimesheetAction(data)).unwrap();
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div>
              ...
              {(hasAccess("task_timesheet", "export") || role === "SUPERADMIN") && taskTimeData && taskTimeData.length > 0 && (
                <button
...
export default CustomerTaskTimesheet;
